...
class selectionfwk_abnormal_select_0200(TestCase):
    ...
    def process(self):
        ...
        Step("步骤5:输入文字")
        driver.input_text_by_keyboard("验证双击窗口是否会触发划词弹窗")

        Step("步骤6:双击窗口")
        driver.mouse_double_click((1745, 392), MouseButton.MOUSE_BUTTON_LEFT)
        ...
        Step("步骤9:双击窗口")
        driver.mouse_double_click((1503, 42), MouseButton.MOUSE_BUTTON_LEFT)

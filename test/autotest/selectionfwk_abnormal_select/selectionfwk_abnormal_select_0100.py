...
class selectionfwk_abnormal_select_0100(TestCase):
    ...
    def process(self):
        ...
        Step("步骤5:输入文字")
        driver.input_text_by_keyboard("验证拖动窗口是否会触发划词弹窗")

        Step("步骤6:拖动窗口")
        driver.mouse_drag((1178, 314), (1447, 472))
        ...
        Step("步骤9:还原窗口位置")
        driver.mouse_drag((1447, 472), (1178, 314))

...
class selectionfwk_kill_service_0100(TestCase):
    ...
    def process(self):
        ...
        Step("步骤3:杀掉扩展进程")
        driver.shell("kill %d" % extension_pid)
        ...
        driver.Assert.not_equal(extension_pid, new_pid)
        ...
        for i in range(2):
            driver.input_text_by_keyboard("kill掉扩展进程，验证是否重新拉起")

...
class selectionfwk_normal_select_0400(TestCase):
    ...
    def process(self):
        ...
        Step("步骤2:点击窗口外")
        driver.mouse_click(BY.key("AppIconCommonView_com.ohos.sceneboard.com.ohos.sceneboard.appcenter.MainAbility"),
